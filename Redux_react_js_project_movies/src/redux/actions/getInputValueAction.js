...
function fetchGetSimilarWords(value) {
    ...
    return axios.get (`https://api.themoviedb.org/3/search/movie?api_key=8ec2e8f7ca273089f162e1aee11d0dcb&language=ru-RUS&query=${value}&page=1&include_adult=false`)
}
