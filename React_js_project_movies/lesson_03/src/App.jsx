...
addToWishList = (event) => {
 ...
 <div className='div_main_container'>
   <Menu showMenu={this.state.showMenu} showMenuHendler={this.showMenuHendler}/>
   <Main showMenuHendler={this.showMenuHendler} showChatHendler={this.showChatHendler} addToFavourite={this.addToFavourite} addToWishList={this.addToWishList} removeFromFavourite={this.removeFromFavourite} removeFromWishList={this.removeFromWishList}/>
